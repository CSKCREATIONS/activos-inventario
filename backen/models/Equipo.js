...
class EquipoModel {
  ...
  static async create(data) {
    ...
    const {
      ...
      observaciones = null,
      procesador = null, nombre_equipo = null,
      licenciamiento_so = null, licenciamiento_office = null,
      marca_monitor = null, placa_monitor = null
    } = data;
    ...
    await pool.execute(
      `INSERT INTO equipos
        (id, placa, serial, tipo_equipo, marca, modelo, sistema_operativo, version_so,
         ...
         procesador, nombre_equipo, licenciamiento_so, licenciamiento_office,
         marca_monitor, placa_monitor)
       VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
      [id, placa, serial, tipo_equipo, marca, modelo, sistema_operativo, version_so,
       ram, disco, tecnologia, criticidad, confidencialidad, estado, fecha_registro,
